...
contract personal_pages {
  ...
  { string nickname; string dob; string bio; string twitter_link; string github_link; string linkedin_link; }
	...
	modifier only_owner() { if (msg.sender != contract_owner){ abort_contract(); } } //cant use it?
	...
	{
  	if (msg.sender != contract_owner) { abort_contract(); } //only the contract owner can set data of a profile
